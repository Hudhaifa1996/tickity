...
class SignupPage2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    context.read<LoginBloc>().add(GovernoratesRequested());
    context.read<LoginBloc>().add(DistrictsRequested());
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
            icon: const Icon(
                  ...
                  ListTile(
                      ...
                      subtitle: DropdownButtonFormField<String>(
                        ...
                        onChanged: (String? newValue) {
                          context
                              .read<LoginBloc>()
                              .add(GovernoratesSelected(newValue));
                        },
                  ...
                  ListTile(
                      ...
                      subtitle: DropdownButtonFormField<String>(
                        ...
                        onChanged: (String? newValue) {
                          context
                              .read<LoginBloc>()
                              .add(DistrictsSelected(newValue));
                        },
                        icon: const Icon(Icons.keyboard_arrow_down, size: 20),
                        isExpanded: true,
                      )),
